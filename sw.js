// En Sağlam Service Worker Kodu (v6 - Yeni Tasarım Uyumlu)

const CACHE_NAME = 'caykahve-cache-v6'; // Sürümü artırarak eski önbelleği geçersiz kılıyoruz
...
const urlsToCache = [
  ...
  REPO_NAME + '/background.png', // Yeni tasarım için arka plan görseli eklendi
